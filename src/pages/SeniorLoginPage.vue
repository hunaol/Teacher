<!--
  SeniorLoginPage.vue — 老年资深教师登录页
  ====================================================
  与 LoginPage 类似，但角色固定为 'senior'：
    - 登录成功直接跳转到 /senior/lesson
    - 提供独立的注册入口（注册后切回登录态）
-->
<script setup>
import { ref } from 'vue'
...
const regForm = ref({ nickname: '', teacherType: 'senior' }) // 注册表单

// 左侧亮点标签
const highlights = ['智能语音备课', '随堂反思', '案例沉淀']

/** 登录：成功后跳转 /senior/lesson */
